...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"The interest earned of the saving is $: {interest_earned}")
    print(f"The updated balance of the saving account is $: {updated_balance + interest_earned}")
    ...
    months = float(input("Enter months of the CD account: "))
    ...
    # ADD YOUR CODE HERE
    print(f"The interest earned of the CD account is $: {interest_earned:,.2f}")
    print(f"The updated balance of the CD is $: {updated_balance:,.2f}")
